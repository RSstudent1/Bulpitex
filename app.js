...
const { Keyboard } = require('@nut-tree/nut-js/dist/lib/keyboard.class');
...
/*function setKeyToogle(key, val){
    if(key === 'Enter'){ 
        ...
        if(val == "down")
            ...
            keyboard.releaseKey(0);
    }
    else if(key === 'Delete'){
        //robot.keyToggle("delete", val);
        if(val == "down")
            keyboard.pressKey(79);
        else
            keyboard.releaseKey(79);
    }
    else if(key === 'Escape'){
        ...
        try {
            ...
            if(val == "down"){
                //keyboard.type(key);
                //keyboard.pressKey(Key[51].toString());
                //console.log(Key[51].toString());
                
                //keyboard.pressKey(Key[51].toString());
                //keyboard.releaseKey(Key[51].toString());
                ...
                val = checkKey(key);
                keyboard.pressKey(val);
            }
            else{
                val = checkKey(key);
                keyboard.releaseKey(val);
            }
            //else
